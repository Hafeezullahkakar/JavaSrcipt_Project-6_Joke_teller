...
//Disbale btn when joke is playing

// Pass joke to VoiceRSS function
function tellMeJoke(joke){
        VoiceRSS.speech({
            key: '25cbe3a3858a4b1f938ad90255b8d44d',
            src: joke,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
...
async function getJokes(){  
    ...
    try{
        ...
        console.log('Woops! error has occurd: ', e)
    }
}
function toggleBtn(){
...
// audio1.addEventListener('ended', toggleBtn)
audio1.addEventListener('play', toggleBtn)
